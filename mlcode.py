...
df = sqlContext.read.load('/FileStore/tables/data.csv',format = 'com.databricks.spark.csv',header='true',inferSchema='true')
...
predictions.select("prediction","label").write.save(path = '/FileStore/tables/pr.csv',format="com.databricks.spark.csv",header='true')
